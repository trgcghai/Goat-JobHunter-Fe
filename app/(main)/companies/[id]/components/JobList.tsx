...
export default function JobList({ jobs, isLoading, isError, savedJobs }: JobListProps) {
    ...
    return (
        <div className="bg-white rounded-xl border border-gray-200 shadow-[0_1px_3px_rgba(0,0,0,0.04)] sticky top-16 max-h-[calc(100vh-120px)] flex flex-col">
