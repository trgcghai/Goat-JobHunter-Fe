...
export default function ReviewTab({ companyName, ratingSummary, recommendedPercentage, totalReviews }: ReviewTabProps) {
        ...
        <div className="space-y-6">
            <div className="bg-white border border-gray-200 rounded-xl shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
                <div className="p-6">
                    ...
                    <div className="flex flex-col md:flex-row py-6 border-b border-dashed border-gray-300 gap-5 items-center justify-between">
