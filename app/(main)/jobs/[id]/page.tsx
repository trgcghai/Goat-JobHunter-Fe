                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
                            <div className="lg:col-span-2">
                                <Card className="mb-8 py-0 h-full">
                                    ...
                                    {isErrorCompany && (
                                        <ErrorMessage message={'Có lỗi xảy ra khi tải thông tin công ty.'} />
                                    )}
                                    {company && !isLoadingCompany && !isErrorCompany && (
                                    ...
                                    <div className="space-y-3">
                                        <HasApplicant user={user!}>
                                            ...
                                            <div
                                                title={
                                                    !isCanApply
                                                        ? 'Bạn đã đạt giới hạn ứng tuyển cho công việc này.'
                                                        : !job.active
                                                          ? 'Công việc đã đóng, không thể ứng tuyển.'
                                                          : ''
                                                }
                                            >
                                                <Button
